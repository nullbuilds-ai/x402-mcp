  ...
  tools: [
    {
      ...
      description:
        "Browse the x402 Bazaar catalog of paid API services. Returns services with their cost, network, and endpoint URL. Filter by search query or blockchain network.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        "Get full payment requirements for a specific x402-enabled service URL, including all payment options, networks, and pricing.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        "Probe a URL and return its x402 payment requirements without making any payment. Shows cost, network, and recipient address.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        "Check the USDC balance of a wallet address on Base. Read-only — no private key required.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      ...
      description:
        "Pay and call an x402-enabled API using your CDP wallet. Handles payment automatically. Returns the actual API response. Requires CDP_API_KEY_ID, CDP_API_KEY_SECRET, CDP_WALLET_SECRET in env.",
      inputSchema: {
        type: "object",
        properties: {
    ...
    },
    {
      name: "get_my_wallet",
      description:
        "Return your x402-mcp CDP wallet address. Use this to find out where to send USDC before making paid API calls. Requires CDP credentials.",
      inputSchema: { type: "object", properties: {} },
    },
    {
      name: "get_payment_history",
      description:
        "Show your recent x402 payment history — what APIs you called, how much you paid, and whether each succeeded.",
      inputSchema: {
        type: "object",
        properties: {
